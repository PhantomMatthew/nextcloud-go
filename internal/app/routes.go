...
func (a *App) mountRoutes() error {
	...
	if a.shares != nil {
		...
		shareesV1 := sharing.ShareesHandler{Version: ocs.V1, Lookup: a.lookup, Users: a.Users}
		shareesV2 := sharing.ShareesHandler{Version: ocs.V2, Lookup: a.lookup, Users: a.Users}
